...
/**
 * DocWordCount class includes main and run methods, and the inner classes Map
 * and Reduce. It outputs the wordcount for each distinct word in each file and
...
public class DocumentWordCount extends Configured implements Tool {

	private static final Logger LOG = Logger.getLogger(DocumentWordCount.class);

	/*
	 * The main method invokes ToolRunner, which creates and runs a new instance
	 * of DocWordCount, passing the command line arguments
	 */
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new DocumentWordCount(), args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		Job job = Job.getInstance(getConf(), " Documentwordcount ");
